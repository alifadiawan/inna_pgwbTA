                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div id="carouselExampleCaptions" class="carousel slide">
                                                            ...
                                                            <div class="carousel-inner">
                                                                <div class="carousel-item active" style="height: 300px">
                                                                    <img src="images/futsal1.jpg" class="d-block w-100"
                                                                        alt="...">
                                                                    <div class="carousel-caption d-none d-md-block">
                                                                    </div>
                                                                </div>
                                                                <div class="carousel-item" style="height: 300px">
                                                                    <img src="images/pmr2.jpg" class="d-block w-100"
                                                                        alt="...">
                                                                    <div class="carousel-caption d-none d-md-block">
                                                                ...
                                                                <div class="carousel-item" style="height: 300px">
                                                                    <img src="images/pmr1.jpg" class="d-block w-100"
                                                                        alt="...">
                                                                    <div class="carousel-caption d-none d-md-block">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="text-container">
                                                            ...
                                                            <p>Melaksanakan kegiatan kemanusiaan di bidang kesehatan dan
                                                                siaga bencana, mempromosikan
                                                                prinsip-prinsip dasar Gerakan Palang merah Indonesia, dan
                       ...
                       @endforeach --}}
                            ...
                            <td>
                                                ...
                                                <div class="modal-body m-3">
                                                    <form>
                                                        ...
                                                        <div class="form-outline mb-4">
                                                            <label class="form-label" for="form1Example1">Nama
                                                                Siswa</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <button type="submit"
                                                                    class="btn btn-warning btn-block">Daftar</button>
                                                            </div>
                                                            <div class="col">
                                ...
                                @elseif (Auth::User()->role == 'dance')
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div id="carouselExampleCaptions" class="carousel slide">
                                                            ...
                                                            <div class="carousel-inner style=" height=" 400px">
                                                                <div class="carousel-item active">
                                                                    <img src="images/fotodance1.jpg" class="d-block w-100"
                                                                        alt="...">
                                                                    <div class="carousel-caption d-none d-md-block">
                                                                    </div>
                                                                </div>
                                                                <div class="carousel-item" style="height: 300px">
                                                                    <img src="images/fotodance2.jpg" class="d-block w-100"
                                                                        alt="...">
                                                                    <div class="carousel-caption d-none d-md-block">
                                                                ...
                                                                <div class="carousel-item" style="height: 400px">
                                                                    <img src="images/dance2.jpg" class="d-block w-100"
                                                                        alt="...">
                                                                    <div class="carousel-caption d-none d-md-block">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="text-container">
                                                            ...
                                                            <label class="mt-2" for="">Deskripsi Ekstra</label>
                                                            <p class="text-light">Melaksanakan kegiatan kemanusiaan di
                                                                bidang kesehatan dan siaga
                                            ...
                                            <div class="row">
                                                <div class="col text-end">
                                                    ...
                                                    <a href="{{ route('admin.preview') }}"
                                                        class="btn text-light">Preview</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="card border-0 shadow p-3 mb-5 rounded-3 text-light"
                                                style="background-color: #2f3037">
                                                <div class="col">
                                                    <h4 class="fw-bold">Jumlah Siswa</h4>
                                                </div>
                                                <div class="col">
                        ...
                        {{-- <h5> {{ $item->}}</h5> --}}
                                        ...
                                        <div class="col">
                                            <div
                                                class="card border-0 p-3 mb-5 rounded-3 text-light"style="background-color: #2f3037">
                                                <div class="col">
                                                    <h4 class="fw-bold">Nama Pembimbing</h4>
                                                </div>
                                                <div class="col">
                                    ...
                                    {{-- daftar siswa --}}
                                    <div class="row">
                                        <div class="card border-0 shadow-lg p-3 mb-5 rounded-3 text-light"
                                            style="background-color: #2f3037">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col">
                                ...
                                <i class="fas fa-plus"></i>
                                                ...
                                                <table
                                                    class="table table-dark table-borderless table-hover mt-4  text-light">
                                                    <thead>
                                                        <tr>
                                                            <th>No</th>
                                                            <th>Nama siswa</th>
