...
@section('content')
    <div class="row">
        <div class="col">
                ...
                @if ($pmr->isEmpty())
                    <div class="row">
                        ...
                        <div class="col text-end">
                            <a href="{{ route('pmr.create') }}" class="btn btn-success">
                        ...
                        <div class="col-6 bg-dark rounded-2 p-4">
                            <div class="text-container">
                                <div class="row">
                                    ...
                                    @foreach ($data as $item)
                                        <h4 class="fw-bold text-warning mt-3">PMR</h4>
            ...
            <div class="row mt-4">
                <div class="col text-end">
                    <a href="{{ route('pmr.edit', $item->id) }}" class="btn btn-warning">Edit</a>
                    <a href="{{ route ('admin.preview') }}" class="btn text-light">Preview</a>
                    <a href="{{ route('pmr.hapus', $item->id) }}" class="btn text-danger">
            ...
            <div class="card border-0 shadow-lg p-3 mb-5 rounded-3 text-light" style="background-color: #2f3037">
                <div class="card-body">
                    ...
                    <table class="table table-borderless mt-4 text-light">
                        ...
                        <tbody>
                            @foreach ($daftar_siswa->where('ekstrakulikuler_id','2') as $item)
